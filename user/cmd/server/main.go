...
import (
	...
	"github.com/aakashloyar/beats/user/config"
	httpuser "github.com/aakashloyar/beats/user/internal/adapter/in/http/user"
	postgres "github.com/aakashloyar/beats/user/internal/adapter/out/postgres"
	"github.com/aakashloyar/beats/user/internal/application/ports/out/system"
	usersvc "github.com/aakashloyar/beats/user/internal/application/service/user"
)
